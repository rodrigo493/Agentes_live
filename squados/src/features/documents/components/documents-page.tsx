...
import type { DmDocumentGroup, GroupDocumentGroup, DocumentFile } from '../actions/document-actions';

interface Props {
  dmGroups: DmDocumentGroup[];
  groupGroups: GroupDocumentGroup[];
  sentFiles: DocumentFile[];
}

export function DocumentsPage({ dmGroups, groupGroups, sentFiles }: Props) {
  return (
    <div className="p-6 space-y-4">
      ...
      <Tabs defaultValue="dm">
        <TabsList>
          <TabsTrigger value="dm">Recebidos</TabsTrigger>
