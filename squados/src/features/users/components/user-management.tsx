...
const NAV_ITEMS_FOR_NON_ADMIN = [
  ...
  { href: '/admin/fabrica',                label: 'Chão de Fábrica' },
  { href: '/admin/operacoes/recepcao',     label: 'Recepção NF' },
  ...
  { href: '/users',                        label: 'Administração' },
  { href: '/groups',                       label: 'Grupos' },
  { href: '/audio',                        label: 'Monitoramento Áudio' },
  { href: '/vision',                       label: 'Visão Computacional' },
